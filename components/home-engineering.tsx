...
export default function HomeEngineering() {
    return (
        <Card className='h-full relative bg-[url(../public/images/code-sample.jpg)] bg-contain bg-center bg-no-repeat my-2'>
            <div
                className='absolute inset-0 bg-white/75 sm:bg-transparent sm:bg-gradient-to-l sm:from-white/95 sm:to-white/25'
            ></div>
